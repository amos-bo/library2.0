...
public class ScreenShotListenManager {
    ...
    private ScreenShotListenManager(Context context) {
        ...
        if (sScreenRealSize == null) {
            ...
            if (sScreenRealSize != null) {
                LogUtils.d("Screen Real Size: " + sScreenRealSize.x + " * " + sScreenRealSize.y);
            } else {
                LogUtils.d("Get screen real size failed.");
            }
        }
    }
    ...
    public void startListen() {
        ...
        try {
            ...
            // 创建内容观察者
            mInternalObserver = new MediaContentObserver(MediaStore.Images.Media
                    .INTERNAL_CONTENT_URI, mUiHandler);
            mExternalObserver = new MediaContentObserver(MediaStore.Images.Media
                    .EXTERNAL_CONTENT_URI, mUiHandler);
    ...
    private void handleMediaContentChange(Uri contentUri) {
        ...
        try {
            ...
            if (cursor == null) {
                LogUtils.e("Deviant logic.");
                return;
            }
            if (!cursor.moveToFirst()) {
                LogUtils.d("Cursor no data.");
                return;
            }
    ...
    private void handleMediaRowData(String data, long dateTaken, int width, int height) {
        if (checkScreenShot(data, dateTaken, width, height)) {
            LogUtils.d("ScreenShot: path = " + data + "; size = " + width + " * " + height
                    + "; date = " + dateTaken);
            ...
            LogUtils.d("Media content changed, but not screenshot: path = " + data
