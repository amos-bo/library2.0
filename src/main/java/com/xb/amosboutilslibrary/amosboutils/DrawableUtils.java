...
public class DrawableUtils {
    /**
     * @param shape       形状 GradientDrawable.LINE、GradientDrawable.LINEAR_GRADIENT、
     *                    GradientDrawable.OVAL、GradientDrawable.RECTANGLE、GradientDrawable.RING、
     ...
     * @return
     */
    public static GradientDrawable getShape(int shape, @ColorInt int color, float corner, int
            strokeSize, @ColorInt int strokeColor, int width, int height, @FloatRange(from =
            0.0D, to = 1.0D) float alpha) {
     ...
     * @return
     */
    public static GradientDrawable getCornerWithStroke(float corner, int stroke, @ColorInt int
            color, @ColorInt int strokeColor) {
     ...
     */
    @ColorInt
    public static int adjustAlpha(@ColorInt int paramInt, @FloatRange(from = 0.0D, to = 1.0D)
            float paramFloat) {
