package com.xb.amosboutilslibrary.amsbobaseui.view;
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public DividerItemDecoration(Context context, int orientation, int
            dividerHeight, int dividerColor) {
        this.setOrientation(orientation);
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
        ...
        //下面super...代码其实调用的就是那个过时的getItemOffsets,
        // 也就是说这个方法体内容也可以通通移到那个过时的getItemOffsets中
        ...
        switch (mOrientation) {
            ...
            case VERTICAL_LIST:
                ...
                outRect.set(0, 0, (itemPosition != childCount) ?
                        mDividerHeight : 0, 0);
                break;
            case HORIZONTAL_LIST:
                childCount -= 1;
                //垂直布局底部留边，最后一行不留
                outRect.set(0, 0, 0, (itemPosition != childCount) ?
                        mDividerHeight : 0);
                break;
        }
    }
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        final int bottom = parent.getMeasuredHeight() - parent
                .getPaddingBottom();
        final int childSize = parent.getChildCount();
        for (int i = 0; i < childSize; i++) {
            final View child = parent.getChildAt(i);
