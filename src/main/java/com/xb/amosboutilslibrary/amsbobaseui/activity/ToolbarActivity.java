package com.xb.amosboutilslibrary.amsbobaseui.activity;
...
import com.xb.amosboutilslibrary.amosboutils.DeviceUtils;
...
public class ToolbarActivity extends BaseActivity {
    ...
    protected void setUpToolbar(Toolbar toolbar) {
        ...
        setNavigationIcon(R.drawable.home_return);
    ...
    public void setContentView(int layoutResID) {
        if (needToolbar()) {
            ...
            rootLayout.addView(getLayoutInflater().inflate(layoutResID, null), ViewGroup
    ...
    protected void addToolbar(LinearLayout rootView) {
        ...
        AppBarLayout appBarLayout = (AppBarLayout) getLayoutInflater().inflate(R.layout.toolbar,
                null);
        ...
        rootView.addView(appBarLayout, ViewGroup.LayoutParams.MATCH_PARENT, DeviceUtils.dip2px
                (this, 48));
    }
    ...
    protected void addButton(@DrawableRes int resId, @Nullable View.OnClickListener l) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                a = getTheme().obtainStyledAttributes(new int[]{android.R.attr
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(DeviceUtils.dip2px(this, 48)
                , DeviceUtils.dip2px(this, 32));
     ...
     * 最右侧添加文字
     */
    protected void addText(CharSequence text, @ColorInt int textColor, int textSize, @Nullable
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams
                .WRAP_CONTENT, DeviceUtils.dip2px(this, 32));
        lp.setMargins(0, 0, DeviceUtils.dip2px(this, 6), 0);
